  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl mb-16">
      ...
      <section className="mb-16 bg-zinc-50 dark:bg-zinc-900/50 p-6 md:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm">
        <h2 className="text-2xl font-bold mb-8 flex items-center justify-center md:justify-start gap-3 border-b border-zinc-200 dark:border-zinc-800 pb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card 1: Experiência */}
          <div className="flex flex-col items-center text-center p-6 bg-white dark:bg-zinc-900 rounded-xl shadow-sm border border-zinc-100 dark:border-zinc-800 hover:border-blue-500 transition-colors">
          ...
          <div className="flex flex-col items-center text-center p-6 bg-white dark:bg-zinc-900 rounded-xl shadow-sm border border-zinc-100 dark:border-zinc-800 hover:border-blue-500 transition-colors">
            ...
            <h3 className="font-bold text-lg mb-2">Trabalho em Equipe</h3>
            <p className="text-zinc-600 dark:text-zinc-400 text-sm">Boa comunicação, proatividade e facilidade para atuar em conjunto.</p>
          </div>
        </div>
      </section>

      {/* Seção: Envio de Currículo */}
      <section className="text-center">
        <div className="inline-flex items-center justify-center p-5 bg-green-100 dark:bg-green-900/30 rounded-full mb-6">
          <FileText className="h-10 w-10 text-green-600 dark:text-green-400" />
        </div>
        <h2 className="text-3xl md:text-4xl font-bold mb-6">Mande seu currículo aqui!</h2>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-6 md:p-8 rounded-xl max-w-2xl mx-auto mb-10 text-left shadow-sm">
          <h3 className="font-bold text-xl mb-4 text-zinc-800 dark:text-zinc-100">Instruções para o envio:</h3>
        ...
        {/* Botões de Ação (Puxando dados do config.json) */}
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            href={`mailto:${email}?subject=Vaga Mecânico - [Seu Nome]`}
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-zinc-900 hover:bg-zinc-800 dark:bg-zinc-100 dark:hover:bg-white text-white dark:text-zinc-900 font-bold py-4 px-8 rounded-lg transition-transform hover:scale-105 shadow-md"
          >
          ...
          <a
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-bold py-4 px-8 rounded-lg transition-transform hover:scale-105 shadow-md"
          >
