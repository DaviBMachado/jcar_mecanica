...
export function TrabalheConosco() {
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl mb-16">
      {/* HERO — sempre sobre overlay escuro */}
      <div
      ...
      <section className="text-center">
        ...
        {/* Botões de Ação — ambos são CTAs primários com bg preenchido, mantêm cor */}
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <a
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 text-white font-bold py-4 px-8 rounded-lg transition-transform hover:scale-105 shadow-md"
          >
